...
//        _menuCollection.backgroundColor = [UIColor colorWithRed:0.33 green:0.62 blue:0.82 alpha:0.1];
...
- (void)showFromRect:(CGRect)rect inView:(UIView *)view
{
    ...
    self.containerView.backgroundColor = [UIColor colorWithRed:0.33 green:0.62 blue:0.82 alpha:1.0];
    //menu frame
